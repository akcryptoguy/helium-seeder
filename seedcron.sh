...
sudo /root/helium-seeder/dnsseed -h sqrseed.nodevalet.io -n squorum.nodevalet.io -p 53 -m akcryptoguy@gmail.com
...
[Service]
WorkingDirectory=/root/helium-seeder
ExecStart=/root/helium-seeder/dnsseed -h sqrseed.nodevalet.io -n squorum.nodevalet.io -p 53 -m akcryptoguy@gmail.com
Restart=on-failure
RestartSec=10
User=root
